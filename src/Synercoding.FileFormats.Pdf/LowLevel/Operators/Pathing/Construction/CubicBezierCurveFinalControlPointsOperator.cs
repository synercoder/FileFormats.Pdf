...
namespace Synercoding.FileFormats.Pdf.LowLevel.Operators.Pathing.Construction
{
    ...
    {
        public CubicBezierCurveFinalControlPointsOperator(double x1, double y1, double x2, double y2)
        {
            X1 = x1;
            Y1 = y1;
            X2 = x2;
        ...
        public CubicBezierCurveFinalControlPointsOperator(Point cp1, Point final)
        {

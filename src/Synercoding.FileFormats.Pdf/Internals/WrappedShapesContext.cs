...
internal class WrappedShapesContext : IShapeContext
{
    private readonly IShapeContext _parent;

    public WrappedShapesContext(ContentStream contentStream, IShapeContext parent)
    {

...
internal class WrappedTextContentContext : ITextContentContext
{
    private readonly ITextContentContext _parent;

    public WrappedTextContentContext(ContentStream contentStream, ITextContentContext parent)
    {
    ...
    public double CharacterSpacing
        => _characterSpacing ?? _parent.CharacterSpacing;

    private double? _wordSpacing;
    public double WordSpacing
        => _wordSpacing ?? _parent.WordSpacing;

    private double? _horizontalScale;
    public double HorizontalScaling
        => _horizontalScale ?? _parent.HorizontalScaling;

    private double? _textLeading;
    public double TextLeading
        => _textLeading ?? _parent.TextLeading;

...
/// </summary>
public class DocumentInformation : IReadOnlyDocumentInformation
{
    ...
    internal DocumentInformation(PdfWriter pdfWriter)
    {
        ...
        ExtraInfo = new DictionaryWrapper(_pdfWriter);
    }
    ...
    IReadOnlyDictionary<string, string>? IReadOnlyDocumentInformation.ExtraInfo => ExtraInfo as IReadOnlyDictionary<string, string>;
}

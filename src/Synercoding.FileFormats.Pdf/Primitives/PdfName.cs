...
public sealed class PdfName : IPdfPrimitive, IEquatable<PdfName>
{
    private static readonly IDictionary<string, PdfName> _reservedNames = new Dictionary<string, PdfName>()
    {
        ...
        { "ColorBurn",        new PdfName("ColorBurn") },
        { "ColorDodge",       new PdfName("ColorDodge") },
        ...
        { "Difference",       new PdfName("Difference") },
        ...
        { "Exclusion",        new PdfName("Exclusion") },
        ...
        { "HardLight",        new PdfName("HardLight") },
        ...
        { "Lighten",          new PdfName("Lighten") },
        { "Luminosity",       new PdfName("Luminosity") },
        ...
        { "Multiply",         new PdfName("Multiply") },
        { "N",                new PdfName("N") },
        { "None",             new PdfName("None") },
        { "Normal",           new PdfName("Normal") },
        { "O",                new PdfName("O") },
        ...
        { "SoftLight",        new PdfName("SoftLight") },

...
public static class PDFDocEncoding
{
    ...
    /// <summary>
    /// Check if the provided <paramref name="value"/> can be encoded with <see cref="PDFDocEncoding"/>.
    /// </summary>
    /// <param name="value">The string to check.</param>
    /// <returns>True when all chars are supported code points, otherwise false.</returns>
